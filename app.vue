  ...
  <div class="antialiased">
    ...
    <header class="rust-header fixed w-full z-50">
      ...
      >
        ...
        >
				<svg v-if="isMobileMenuOpen" class="w-8 h-8 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
				<svg v-else class="w-8 h-8 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>
        </button>
      </div>
    ...
    <!-- Contenido principal -->
    <main
      class="flex items-center justify-center min-h-[calc(100vh-6rem)] px-4 py-8 flex-col space-y-6"
    >
      <!-- Tarjeta Discord -->
        ...
        >
          ...
          <div class="px-6 py-4">
            <p class="text-amber-100 mb-4 text-center sm:text-left">
              {{ languageContent[currentLanguage].discordDescription }}
            </p>
            ...
            >
              <div class="flex items-center">
                ...
                <span class="text-green-400 text-sm"
                  >{{ languageContent[currentLanguage].online }}:
                  <span>{{ discordMembers }}</span></span
                >
              </div>
              ...
              >
                ...
                {{ languageContent[currentLanguage].joinDiscord }}
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="bg-[#2a1e13] border-b border-[#5c3a21] px-6 py-4">
            <div class="flex items-center">
              ...
              <h2
                class="ml-3 text-xl font-bold text-amber-300 uppercase tracking-wide"
              >
                {{ languageContent[currentLanguage].connectToServer }}
              </h2>
            </div>
          </div>
            ...
            <div v-if="currentServerData" class="server-content">
              ...
              >
                <div class="flex items-center mb-3 sm:mb-0">
                  ...
                  />
                  <span class="text-green-400 text-sm"
                    >{{ languageContent[currentLanguage].status }}:
                    <span
                      :class="
                        currentServerData.status === 'online'
                          ? 'text-green-400'
                ...
                <span class="text-amber-200 text-sm"
                  >{{ languageContent[currentLanguage].players }}:
                  <span>{{ currentServerData.players }}</span>
                </span>
              </div>
              ...
              >
                <div class="flex items-center justify-between mb-2">
                  <span class="text-amber-100 font-mono text-sm"
                    >{{ languageContent[currentLanguage].serverIP }}:</span
                  >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
                  ...
                  >
                    ...
                    {{ languageContent[currentLanguage].copyIP }}
                  </button>
                  ...
                  >
                    ...
                    {{ languageContent[currentLanguage].connectDirectly }}
                  </a>
                </div>
              </div>
            </div>
...
const changeLanguage = (lang: string) => {
  ...
  isMobileMenuOpen.value = false; // Cerrar menú móvil al cambiar idioma
};
